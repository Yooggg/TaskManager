...
public class CreateUserCommandValidator : UserCommandValidatorBase<CreateUserCommand>
{
    ...
    public CreateUserCommandValidator(IUserRepository userRepository) : base(userRepository)
    {
    ...
    private void ValidatePassword()
    {
        ...
        RuleFor(userCommand => userCommand.PasswordConfirmation).Equal(userCommand => userCommand.Password).WithMessage("Confirmation password and password are equal");
